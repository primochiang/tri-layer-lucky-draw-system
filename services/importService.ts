...
export const generateParticipantsTemplate = (): Blob => {
  ...
  const data = [
    { '編號': '001', '姓名': '王小明', '社團': '南區', '分區': '第一分區', '職稱': '社長' },
    { '編號': '002', '姓名': '李大華', '社團': '逸仙', '分區': '第一分區', '職稱': '社員' },
    { '編號': '003', '姓名': '張美玲', '社團': '南欣', '分區': '第四分區', '職稱': '社員' },
  ];
...
export const generatePrizesTemplate = (): Blob => {
  const wb = XLSX.utils.book_new();
  const data = [
    { '階段': '第一階段', '分區': '第一分區', '社團/職稱': '南區', '贊助人': 'Queenie', '獎項名稱': '社長獎', '獎品內容': '紅包 $2,000', '數量': 3 },
